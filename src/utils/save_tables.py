...
def replace_for_latex(df):
    ...
    latex_table = latex_table.replace(".0000000 ", "\phantom{.0000000} ")
    latex_table = latex_table.replace(".000000 ", "\phantom{.000000} ")
    latex_table = latex_table.replace(".00000 ", "\phantom{.00000} ")
